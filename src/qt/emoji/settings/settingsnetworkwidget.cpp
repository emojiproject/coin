...
#include "qt/emoji/settings/settingsnetworkwidget.h"
#include "qt/emoji/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/emoji/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(EMOJIGUI* _window, QWidget *parent) :
