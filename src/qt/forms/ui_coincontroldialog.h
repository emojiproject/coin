...
"               padding-right:4px;"));
    ...
    void retranslateUi(QDialog *CoinControlDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("CoinControlDialog", "Select EMOJ Outputs to Spend", Q_NULLPTR));
        labelCoinControlAmountText->setText(QApplication::translate("CoinControlDialog", "Amount", Q_NULLPTR));
        labelCoinControlAmount->setText(QApplication::translate("CoinControlDialog", "0.00 EMOJ", Q_NULLPTR));
        ...
        labelCoinControlFee->setText(QApplication::translate("CoinControlDialog", "0.00 EMOJ", Q_NULLPTR));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("CoinControlDialog", "0.00 EMOJ", Q_NULLPTR));
