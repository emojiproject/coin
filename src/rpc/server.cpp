...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EMOJ features */
        {"EMOJ", "listmasternodes", &listmasternodes, true },
        {"EMOJ", "getmasternodecount", &getmasternodecount, true },
        {"EMOJ", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"EMOJ", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"EMOJ", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"EMOJ", "masternodecurrent", &masternodecurrent, true },
        {"EMOJ", "startmasternode", &startmasternode, true },
        {"EMOJ", "createmasternodekey", &createmasternodekey, true },
        {"EMOJ", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"EMOJ", "listmasternodeconf", &listmasternodeconf, true },
        {"EMOJ", "getmasternodestatus", &getmasternodestatus, true },
        {"EMOJ", "getmasternodewinners", &getmasternodewinners, true },
        {"EMOJ", "getmasternodescores", &getmasternodescores, true },
        {"EMOJ", "mnsync", &mnsync, true },
        {"EMOJ", "spork", &spork, true },
...
{
    return "> EMOJ-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27559/\n";
}
