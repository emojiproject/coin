 ...
 * EMOJI system. There are three: the main network on which people trade goods
...
public:
    ...
    int EMOjiBadBlockTime() const { return nEMOjiBadBlockTime; }
    int EMOjiBadBlocknBits() const { return nEMOjiBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nEMOjiBadBlockTime;
    unsigned int nEMOjiBadBlocknBits;
