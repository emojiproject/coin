Contributing to Emoj Coin
============================

The Emoj Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/EMOji/emoji/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Emoj Coin project, and is not to be
confused with overall EMOJI Network Protocol consensus changes.

Whether a pull request is merged into Emoj Coin rests with the project merge
...
Patches that change EMOJI consensus rules are considerably more involved than
...
Where a patchset proposes to change the EMOJI consensus, it must have been
...
The project leader is the release manager for each Emoj Coin release.
