...
#include "qt/emoji/coincontrolemojwidget.h"
#include "qt/emoji/forms/ui_coincontrolemojwidget.h"

CoinControlEmojWidget::CoinControlEmojWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlEmojWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select EMOJ Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("EMOJ");
    ...
    ui->labelValueAfter->setText("0.00 EMOJ");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 EMOJ");
    ui->labelValueFee->setText("0.00 EMOJ");
...
CoinControlEmojWidget::~CoinControlEmojWidget()
{
    delete ui;
}
