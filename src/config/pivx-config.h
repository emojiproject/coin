...
#define PACKAGE_BUGREPORT "https://github.com/emojiproject/EMOJ"

/* Define to the full name of this package. */
#define PACKAGE_NAME "EMOJ Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "EMOJ Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "EMOJ"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://emojiproject.net/"
