...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	(0, uint256("0x000007571768b45451821d7e0fdeae69a1fb08b4dec9f8443addd3049c21a8f3"))
	(25292, uint256("0xf5c5dba32311ac4e4838c2a3070db4a22326009e9d58c92a3107e64e897a5583"))
	(26828, uint256("0x6ff792145203787119831a3acd147eee3a51226019d9c3dded757bb61f4c59cf"))
	(35534, uint256("0x59577dd5f9050792479379c0c46883c1e89b0df9582e93485a954747917b1fa8"))
	(338040, uint256("0x2fc1d17220f169c19dcec6e4d356c737d551dd567ca4cc2a4640121b49854ef7"))
	(400000, uint256("c5aed4168b5b214988e7514f05889e5bd67c9262b7c4058f2ad2699999b268d8"))
	(450000, uint256("6f113550eebccbf61dbe895245fca98406a46c0a81fd2b60cbce7f3ff5ffaaf3"))
	(500000, uint256("2e7dd9c81c83b92172b5a0eab9d6115c7585f48aaa5ef6d7a40a14be54cb2350"))
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1630440900, // * UNIX timestamp of last checkpoint block 1595395950
	338040,    // * total number of transactions between genesis and last checkpoint 153163
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 15452;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // EMOJI starting difficulty is 1 / 2^12
        ...
        nLastPOWBlock = 250;
        nEMOjiBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nEMOjiBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nEnforceNewSporkKey = 1606869953; //!> Sporks signed after Thursday, 30 July 2020 06:30:00 AM GMT must use the new spork key
        nRejectOldSporkKey = 1606946400; //!> Fully reject old spork key after Saturday, 1 August 2020 01:00:00 AM GMT
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "The world is a sphere";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1606869149;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 6219869;

        hashGenesisBlock = genesis.GetHash();
	assert(hashGenesisBlock == uint256("0x000007571768b45451821d7e0fdeae69a1fb08b4dec9f8443addd3049c21a8f3"));
        assert(genesis.hashMerkleRoot == uint256("0x6947b974ad6d2f69773c1bc9a5df8aefb9b96b8eef6047df96eeb418169e9344"));

        vSeeds.push_back(CDNSSeedData("155.138.155.96", "155.138.155.96"));
        vSeeds.push_back(CDNSSeedData("78.141.233.110", "78.141.233.110"));
	...
	vSeeds.push_back(CDNSSeedData("node4.emojiproject.net", "node4.emojiproject.net"));	
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 94);     // starting with 'E'
        ...
        strSporkPubKey = "04f9244ef0f156d5fe63d453a755a8a27fd8acd708c8fc1608992745919687606d0220daeeb3a781c26be0c2cb98c9b088e31ede80fa81d38a68040d4fffc53c5d";
        strSporkPubKeyOld = "0457179d628d9f957d9171563007038b73fcfbae6a0c7eab05d84ffddc5af831c35f6d852e0aa499e7a9c9a9564d711d6d97da9a4c999a75d6cf5647d2d28a0aa5";
        strObfuscationPoolDummyAddress = "EVoYe2iJMAbueWAYFAwiiCwx2wYABZRv1x";
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zemoj to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nEMOjiBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nEMOjiBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet emoji addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet emoji script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet emoji BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet emoji BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet emoji BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "emojfGRkekRyDRNeJiLtYVEbvhXrNbmox";
