...
const char * const PIVX_CONF_FILENAME = "EMOJ.conf";
const char * const PIVX_PID_FILENAME = "EMOJ.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\EMOJ
// Windows >= Vista: C:\Users\Username\AppData\Roaming\EMOJ
// Mac: ~/Library/Application Support/EMOJ
// Unix: ~/.EMOJ
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "EMOJ";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty EMOJ.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=27559\naddnode=seed1.emojiproject.net:27560\naddnode=seed2.emojiproject.net:27560\naddnode=seed3.emojiproject.net:27560\naddnode=seed4.emojiproject.net:27560\naddnode=seed5.emojiproject.net:27560\naddnode=seed6.emojiproject.net:27560\naddnode=seed7.emojiproject.net:27560\naddnode=seed8.emojiproject.net:27560\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override EMOJ.conf
