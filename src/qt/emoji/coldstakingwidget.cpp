...
#include "qt/emoji/forms/ui_coldstakingwidget.h"
#include "qt/emoji/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/emoji/requestdialog.h"
#include "qt/emoji/tooltipmenu.h"
...
ColdStakingWidget::ColdStakingWidget(EMOJIGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your EMOJs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept EMOJ delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select EMOJ outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 EMOJ" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
