...
#ifndef EMOJI_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define EMOJI_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //EMOJI_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
