...
RESOURCES += src/qt/emoji.qrc src/qt/emoji_locale.qrc

TRANSLATIONS += src/qt/locale/emoji_bg.ts \
                src/qt/locale/emoji_de.ts \
                src/qt/locale/emoji_en.ts \
                src/qt/locale/emoji_es.ts \
                src/qt/locale/emoji_fi.ts \
                src/qt/locale/emoji_fr.ts \
                src/qt/locale/emoji_it.ts \
                src/qt/locale/emoji_ja.ts \
                src/qt/locale/emoji_pl.ts \
                src/qt/locale/emoji_pt.ts \
                src/qt/locale/emoji_ru.ts \
                src/qt/locale/emoji_sk.ts \
                src/qt/locale/emoji_sv.ts \
                src/qt/locale/emoji_vi.ts \
                src/qt/locale/emoji_zh_CN.ts \
                src/qt/locale/emoji_zh_TW.ts
