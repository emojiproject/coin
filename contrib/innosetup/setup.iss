...
#define MyAppName "EMOJ Core"
#define MyAppPublisher "2021-2022 The EMOJ Developers"
#define MyAppURL "https://github.com/emojiproject/EMOJ"
#define MyAppExeName "EMOJ-qt.exe"
#define MyAppExtraData "https://github.com/emojiproject/EMOJ/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\EMOJ-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\EMOJ\EMOJ-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\EMOJ\EMOJ-Qt,strDataDir|{userappdata}\EMOJ\}');
  Result := True;
end;
