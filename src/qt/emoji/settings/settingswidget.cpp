...
#include "qt/emoji/settings/forms/ui_settingswidget.h"
#include "qt/emoji/settings/settingsbackupwallet.h"
#include "qt/emoji/settings/settingsbittoolwidget.h"
#include "qt/emoji/settings/settingswalletrepairwidget.h"
#include "qt/emoji/settings/settingswalletoptionswidget.h"
#include "qt/emoji/settings/settingsmainoptionswidget.h"
#include "qt/emoji/settings/settingsdisplayoptionswidget.h"
#include "qt/emoji/settings/settingsmultisendwidget.h"
#include "qt/emoji/settings/settingsinformationwidget.h"
#include "qt/emoji/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(EMOJIGUI* parent) :
    PWidget(parent),
