...
/* EMOJ GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "EMOJ"
#define QAPP_ORG_DOMAIN "EMOJ.org"
#define QAPP_APP_NAME_DEFAULT "EMOJ-Qt"
#define QAPP_APP_NAME_TESTNET "EMOJ-Qt-testnet"
