...
"""Verify that starting EMOJ with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start EMOJ with -? for help text")
        ...
        self.log.info("Start EMOJ with -version for version information")
