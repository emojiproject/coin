...
extern UniValue DoZemojSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzemojseed(const UniValue& params, bool fHelp);
extern UniValue getzemojseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzemoj(const UniValue& params, bool fHelp);
extern UniValue dzemojstate(const UniValue& params, bool fHelp);
