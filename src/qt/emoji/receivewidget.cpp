...
#include "qt/emoji/forms/ui_receivewidget.h"
...
#include "qt/emoji/addressholder.h"
...
ReceiveWidget::ReceiveWidget(EMOJIGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive EMOJ."));
