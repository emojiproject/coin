...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("EMOJ EMOJ-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  EMOJ-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded EMOJ transaction") + "\n" +
                               "  EMOJ-tx [options] -create [commands]   " + _("Create hex-encoded EMOJ transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded EMOJ transaction
