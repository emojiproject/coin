...
#include "qt/emoji/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/emoji/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(EMOJIGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to EMOJIGUI::handleRestart()
