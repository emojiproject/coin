...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Emoj Coin emoji-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  emoji-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded emoji transaction") + "\n" +
                               "  emoji-tx [options] -create [commands]   " + _("Create hex-encoded emoji transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded emoji transaction
