...
#include "qt/emoji/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/emoji/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(EMOJIGUI* _window, QWidget *parent) :
