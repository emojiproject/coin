/* src/config/emoji-config.h.  Generated from emoji-config.h.in by configure.  */
/* src/config/emoji-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef EMOJ_CONFIG_H

#define EMOJ_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/EMOji/emoji/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Emoj Coin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Emoj Coin 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "emoji"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://emoji.org/"
