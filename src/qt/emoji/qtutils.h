...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, EMOJIGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, EMOJIGUI *gui, double posX = 3);
