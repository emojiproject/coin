...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected EMOJ and zEMOJ supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zEMOJsupply']:
                assert_equal(node['zEMOJsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check EMOJ and zEMOJ supply at the beginning
        # ------------------------------------------
        # zEMOJ supply: 2 coins for each denomination
        ...
        # EMOJ supply: block rewards minus burned fees for minting
        ...
        # Verify that EMOJ and zEMOJ supplies were properly updated after the spends and reorgs
        self.log.info("Check EMOJ and zEMOJ supply...")
