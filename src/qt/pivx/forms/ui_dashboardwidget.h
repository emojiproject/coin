...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountPiv->setText(QStringLiteral("0 EMOJ"));
        ...
        labelPiv->setText(QStringLiteral("EMOJ"));
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get EMOJ", Q_NULLPTR));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Rewards Chart", Q_NULLPTR));
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of EMOJ staked.", Q_NULLPTR));
        ...
        labelMNRewards->setText(QApplication::translate("DashboardWidget", "EMOJ MN", Q_NULLPTR));
