Contributing to EMOJ Core
============================

The EMOJ Core project operates an open contributor model where anyone is
...
The following applies to code changes to the EMOJ Core project, and is not to be
confused with overall EMOJ Network Protocol consensus changes.

Whether a pull request is merged into EMOJ Core rests with the project merge
...
Patches that change EMOJ consensus rules are considerably more involved than
...
Where a patchset proposes to change the EMOJ consensus, it must have been
...
The project leader is the release manager for each EMOJ Core release.
