    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of EMOJ earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 EMOJ");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair EMOJ
