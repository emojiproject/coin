...
/** Utility functions used by the EMOJI Qt UI.
 */
namespace GUIUtil
{
...
// Render EMOJI addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZemoj = false);
