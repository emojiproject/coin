...
* Fill in the following data:
    * Application Name: `EMOJ Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The EMOJ Developers`
    * Application Website: `https://emojiproject.net/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `EMOJ`
* Add application files:
    * Select the file `EMOJ-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `EMOJ-2.0.0-win64-setup.exe`
