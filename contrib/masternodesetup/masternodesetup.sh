...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='EMOJ.conf'
CONFIGFOLDER='/root/.EMOJ'
COIN_DAEMON='EMOJd'
COIN_CLI='EMOJ-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/EMOJ/EMOJ/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
