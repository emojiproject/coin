                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzEMOJPathCustom = GetArg("-zemojbackuppath", "");
    ...
    if(!strzEMOJPathCustom.empty()) {
        ui->wallet_customzemojbackuppath->setText(QString::fromStdString(strzEMOJPathCustom));
        ui->wallet_customzemojbackuppath_label->setVisible(true);
        ui->wallet_customzemojbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzEMOJPathCustom.empty()) && nCustomBackupThreshold > 0) {
