...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EMOJI features */
        {"emoji", "listmasternodes", &listmasternodes, true, true, false},
        {"emoji", "getmasternodecount", &getmasternodecount, true, true, false},
        {"emoji", "masternodeconnect", &masternodeconnect, true, true, false},
        {"emoji", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"emoji", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"emoji", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"emoji", "masternodecurrent", &masternodecurrent, true, true, false},
        {"emoji", "masternodedebug", &masternodedebug, true, true, false},
        {"emoji", "startmasternode", &startmasternode, true, true, false},
        {"emoji", "createmasternodekey", &createmasternodekey, true, true, false},
        {"emoji", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"emoji", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"emoji", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"emoji", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"emoji", "getmasternodescores", &getmasternodescores, true, true, false},
        {"emoji", "preparebudget", &preparebudget, true, true, false},
        {"emoji", "submitbudget", &submitbudget, true, true, false},
        {"emoji", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"emoji", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"emoji", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"emoji", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"emoji", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"emoji", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"emoji", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"emoji", "checkbudgets", &checkbudgets, true, true, false},
        {"emoji", "mnsync", &mnsync, true, true, false},
        {"emoji", "spork", &spork, true, true, false},
        {"emoji", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> emoji-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:15451/\n";
}
