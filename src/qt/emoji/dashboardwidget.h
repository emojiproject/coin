...
#include "config/emoji-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalEmoj = 0;
    qint64 totalZemoj = 0;
    QList<qreal> valuesEmoj;
    QList<qreal> valueszEmoj;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(EMOJIGUI* _window);
    ~DashboardWidget();
