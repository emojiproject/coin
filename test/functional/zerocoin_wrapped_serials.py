...
from fake_stake.base_test import EMOJI_FakeStakeTest

class zEMOJwrappedSerialsTest(EMOJI_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zEMOJs..." % DENOM_TO_USE)
