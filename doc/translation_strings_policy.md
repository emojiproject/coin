...
This document provides guidelines for internationalization of the Emoj Coin software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `emoji_en.ts` remains unchanged.
