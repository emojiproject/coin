// Copyright (c) 2017-2018 The EMOJI developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef EMOJI_ZEMOJWALLET_H
#define EMOJI_ZEMOJWALLET_H
...
public:
    CzEMOJWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZEMOJ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZEMOJ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
