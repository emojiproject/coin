...
// Copyright (c) 2021-2023 The EMOJ Developers
...
{
    const char* pszTimestamp = "EMOJ 2.0 ";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000009230a746dac5dc2dd81778b2d00e7b6629b8544380ba98877a3196cbf0a"))

;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1707396489, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1707396489, 18609396, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();


        assert(consensus.hashGenesisBlock == uint256S("0x000009230a746dac5dc2dd81778b2d00e7b6629b8544380ba98877a3196cbf0a"));
        assert(genesis.hashMerkleRoot == uint256S("0xcb6353abf80a4c6385d52ee49c0c45705dc26d9ddfe32d13d0c313dd401c77f3"));
        ...
        consensus.nMaxMoneyOut = 15000000000 * COIN;
        ...
        // spork keys
        consensus.strSporkPubKey = "04f9244ef0f156d5fe63d453a755a8a27fd8acd708c8fc1608992745919687606d0220daeeb3a781c26be0c2cb98c9b088e31ede80fa81d38a68040d4fffc53c5d";
        ...
        consensus.mBurnAddresses = {
           { "EMOJBuRnEMOJxxxxxxxxxxxxTpDJ6", 0 }
        };
    	...
    	vSeeds.push_back(CDNSSeedData("seed1",  "seed1.emojiproject.net"));
        vSeeds.push_back(CDNSSeedData("seed2",  "seed2.emojiproject.net"));
        vSeeds.push_back(CDNSSeedData("seed3",  "seed3.emojiproject.net"));
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1707396489, 16549955, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // EMOJ starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.__emojiproject.net__", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet EMOJ addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet EMOJ script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet EMOJ BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet EMOJ BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet EMOJ BIP44 coin type is '1' (All coin's testnet default)
