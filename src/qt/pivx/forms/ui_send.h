...
"             }"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Send public coins (EMOJ)", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "EMOJ address or contact label", Q_NULLPTR));
